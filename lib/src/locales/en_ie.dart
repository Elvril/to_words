import 'package:to_words/src/interfaces/locale.dart';
import 'package:to_words/src/models/locale_config.dart';
import 'package:to_words/src/models/number_word_map.dart';
import 'package:to_words/to_words.dart';

class LocaleEnIe implements Locale {
  @override
  final LocaleConfig config = const LocaleConfig(
    ...
    numberWordsMapping: [
      NumberWordMap(number: 1000000000000000, value: 'Quadrillion'),
      NumberWordMap(number: 1000000000000, value: 'Trillion'),
      NumberWordMap(number: 1000000000, value: 'Billion'),
